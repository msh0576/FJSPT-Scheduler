...
class TFJSPModel_DTrans(nn.Module):
    ...
    def forward(self, state, baseline=False):
        ...
        # if self.encoder_version == 3 and self.decoder_version == 4:
        #     print(f'offload_trans_time:{offload_trans_time[0]}')
        #     print(f'onload_trans_time:{onload_trans_time[0]}')
        #     print(f'action ope-ma-job-veh:{action[:,0]}')
